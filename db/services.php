...
$functions = [
    ...
    'mod_longpage_update_readingskill' => [
        ...
        'description' => 'Updates the reading comprehension Skills',
        'type' => 'write',
        'capabilities' => 'mod/longpage:view',
        'ajax' => true,
    ],
    'mod_longpage_search_next_question' => [
        'classname' => 'mod_longpage\\external\\elo_services',
        'methodname' => 'search_next_question',
        'description' => 'Updates the Question Difficulty estimations',
        'type' => 'write',
        'capabilities' => 'mod/longpage:view',
        'ajax' => true,
    ],
    'mod_longpage_calibrate_Question' => [
        'classname' => 'mod_longpage\\external\\elo_services',
        'methodname' => 'calibrate_question_manually',
        'description' => 'Calibrates a Question with the question id',
        'type' => 'write',
        'capabilities' => 'mod/longpage:view',
        'ajax' => true,
    ],
    'mod_longpage_get_QuestionData' => [
        'classname' => 'mod_longpage\\external\\elo_services',
        'methodname' => 'get_question_data_ajax',
        'description' => 'Gets question data including difficulty and calibration status',
        'type' => 'read',
        'capabilities' => 'mod/longpage:view',
        'ajax' => true,
    ],
    'mod_longpage_set_comprehensionFactor' => [
        'classname' => 'mod_longpage\\external\\elo_services',
        'methodname' => 'set_comprehension_factor',
        'description' => 'Sets the comprehension Factor of a User',
        'type' => 'write',
        'capabilities' => 'mod/longpage:view',
        'ajax' => true,
    ],
    'mod_longpage_log_reading_behavior_event' => [
        'classname' => 'mod_longpage\\external\\reading_behavior_services',
        'methodname' => 'log_reading_behavior_event',
        'description' => 'Persists one classified reading-behavior data point (scan/read/study/regression/preview)',
        'type' => 'write',
        'capabilities' => 'mod/longpage:view',
        'ajax' => true,
    ],
    'mod_longpage_log_intersection_events' => [
        'classname' => 'mod_longpage\\external\\reading_behavior_services',
        'methodname' => 'log_intersection_events',
        'description' => 'Persists a batch of raw IntersectionObserver telemetry rows, independent of any classification',
        'type' => 'write',
        'capabilities' => 'mod/longpage:view',
        'ajax' => true,
    ],
