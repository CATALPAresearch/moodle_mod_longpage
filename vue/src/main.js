...
export const init = (courseId, longpageid, pageName, userId, content, scrollTop,
    showreadingprogress, showreadingcomprehension, showsearch, showtableofcontents, 
    showposts, showhighlights, showbookmarks, showeditquestionsnoai, showeditquestionsai, 
    tags, isAdmin) => {
    try {
