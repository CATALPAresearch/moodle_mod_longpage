...
$string['aiquestiongenerationexplain'] = 'Configure AI-powered question generation. The actual AI server (KI:connect, Ollama, ...) is configured under Site administration > General > AI providers.';
...
$string['aipolicynotaccepted'] = 'You must accept the AI usage policy before AI-based question generation can be used.';
$string['aipolicypagetitle'] = 'AI usage policy';
$string['aipolicyaccepted'] = 'Thank you, the AI usage policy has been accepted.';
$string['aipolicyalreadyaccepted'] = 'You have already accepted the AI usage policy.';
$string['aipolicyclosetab'] = 'You can close this tab and try again.';
$string['aiprovidernote'] = 'The LLM server, model and API key are configured via Moodle\'s AI Provider subsystem (Site administration > General > AI providers > Longpage AI provider), not here.';
...
$string['privacy:metadata:longpage_reading_positions'] = 'Information about user reading progress.';
$string['privacy:metadata:longpage_reading_positions:longpageid'] = 'The ID of the longpage activity.';
$string['privacy:metadata:longpage_reading_positions:scrolltop'] = 'The scroll position.';
$string['privacy:metadata:longpage_reading_positions:section'] = 'The section being read.';
$string['privacy:metadata:longpage_reading_positions:timemodified'] = 'The time when the progress was last updated.';
$string['privacy:metadata:longpage_reading_positions:userid'] = 'The ID of the user.';
...
$string['features_teacherDashboard_readingBehaviorTrendTitle'] = 'Reading Behavior Over the Semester';
$string['features_teacherDashboard_readingBehaviorByStudentTitle'] = 'Reading Behavior by Student';
$string['features_teacherDashboard_noReadingBehaviorData'] = 'No reading-behavior data yet for this semester.';
$string['features_teacherDashboard_chartLabels_sharePercent'] = 'Share of classified reading events (%)';
$string['features_teacherDashboard_chartLabels_scan'] = 'Scan';
$string['features_teacherDashboard_chartLabels_read'] = 'Read';
$string['features_teacherDashboard_chartLabels_study'] = 'Study';
$string['features_teacherDashboard_chartLabels_regression'] = 'Regression';
$string['features_teacherDashboard_chartLabels_preview'] = 'Preview';
$string['features_teacherDashboard_chartLabels_calendarWeek'] = 'Calendar Week';
$string['features_teacherDashboard_chartLabels_student'] = 'Student';
$string['features_teacherDashboard_chartLabels_avgCoverage'] = 'Ø Coverage';
$string['features_teacherDashboard_chartLabels_notes'] = 'Notes';
$string['features_teacherDashboard_chartLabels_comments'] = 'Comments';
$string['features_teacherDashboard_chartLabels_lastActive'] = 'Last active';
$string['features_teacherDashboard_columnHelp_scan'] = 'Share of dwell time spent briefly scanning past this content.';
$string['features_teacherDashboard_columnHelp_read'] = 'Share spent reading at a normal pace.';
$string['features_teacherDashboard_columnHelp_study'] = 'Share spent studying closely, well above normal reading pace.';
$string['features_teacherDashboard_columnHelp_regression'] = 'Share spent scrolling back up to re-read — often a sign of confusion or double-checking.';
$string['features_teacherDashboard_columnHelp_preview'] = 'Share classified as a brief preview glance, not sustained reading.';
$string['features_teacherDashboard_columnHelp_avgCoverage'] = "On average, how much of each element's own height was actually scrolled into view.";
$string['features_teacherDashboard_columnHelp_highlights'] = 'Number of text passages the student highlighted.';
$string['features_teacherDashboard_columnHelp_bookmarks'] = 'Number of page-location bookmarks the student set.';
$string['features_teacherDashboard_columnHelp_notes'] = 'Number of personal, non-public notes the student wrote.';
$string['features_teacherDashboard_columnHelp_comments'] = 'Number of public comments the student posted.';
$string['features_teacherDashboard_columnHelp_lastActive'] = "Date of the student's most recent classified reading activity.";
$string['features_teacherDashboard_instancesLabel'] = 'Longpage instances';
$string['features_teacherDashboard_instancesPlaceholder'] = 'Type to search instances…';
$string['features_teacherDashboard_instancesNotFound'] = 'No matching instance';
$string['features_teacherDashboard_selectAllInstances'] = 'Select all';
$string['features_teacherDashboard_removeInstance'] = 'Remove';
$string['features_teacherDashboard_noInstanceSelected'] = 'Select at least one longpage instance to see analytics.';
